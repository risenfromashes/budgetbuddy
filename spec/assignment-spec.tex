...
\title{BudgetBuddy: Code Refactoring Assignment}
...
\begin{verbatim}
git clone https://github.com/risenfromashes/budget-buddy
cd budget-buddy
\end{verbatim}
...
while making sure that appropriate formatting formatting used for each case.
